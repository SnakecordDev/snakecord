...
The following section outlines the API of snakecord.
...
.. autofunction:: snakecord.opus.load_opus

.. autofunction:: snakecord.opus.is_loaded

.. _snakecord-api-events:
...
.. function:: on_connect()
    ...
    Called when the client has successfully connected to Snakecord. This is not
...
.. function:: on_disconnect()
    ...
    Called when the client has disconnected from Snakecord, or a connection attempt to Snakecord has failed.
    This could happen either through the internet being disconnected, explicit calls to close,
    or Snakecord terminating the connection one way or the other.
...
.. function:: on_shard_connect(shard_id)
    ...
    to denote when a particular shard ID has connected to Snakecord.
...
.. function:: on_shard_disconnect(shard_id)
    ...
    to denote when a particular shard ID has disconnected from Snakecord.
...
.. function:: on_socket_event_type(event_type)
    ...
    from the Snakecord gateway.

    .. versionadded:: 2.0

    :param event_type: The event type from Snakecord that is received, e.g. ``'READY'``.
...
.. function:: on_entitlement_delete(entitlement)
    ...
    - Snakecord issues a refund for the subscription.
    - Snakecord removes an entitlement from a user.
...
.. function:: on_ready()
    ...
    Called when the client is done preparing the data received from Snakecord. Usually after login is successful
...
.. function:: on_audit_log_entry_create(entry)
    ...
    .. warning::
        ...
        attribute will usually be a :class:`snakecord.Object` and the
...
.. function:: on_invite_delete(invite)
    ...
    .. note::
        ...
        filled by the Snakecord gateway for this event is :attr:`Invite.code`.
...
.. function:: on_interaction(interaction)
    ...
    .. warning::
        ...
        with the :class:`~snakecord.ui.View` instead as it provides a nicer user experience.
...
.. function:: on_member_update(before, after)
    ...
    Due to a Snakecord limitation, this event is not dispatched when a member's timeout expires.
...
.. function:: on_raw_message_edit(payload)
    ...
    denotes an "embed" only edit, which is an edit in which only the embeds are updated by the Snakecord
    embed server.
...
.. function:: on_reaction_add(reaction, user)
    ...
    .. note::
        ...
        but due to Snakecord not providing updated user information in a direct message
...
.. _snakecord-api-utils:

Utility Functions
-----------------

.. autofunction:: snakecord.utils.find

.. autofunction:: snakecord.utils.get

.. autofunction:: snakecord.utils.setup_logging

.. autofunction:: snakecord.utils.maybe_coroutine

.. autofunction:: snakecord.utils.snowflake_time

.. autofunction:: snakecord.utils.time_snowflake

.. autofunction:: snakecord.utils.oauth_url

.. autofunction:: snakecord.utils.remove_markdown

.. autofunction:: snakecord.utils.escape_markdown

.. autofunction:: snakecord.utils.escape_mentions

.. class:: ResolvedInvite

    A data class which represents a resolved invite returned from :func:`snakecord.utils.resolve_invite`.
...
.. autofunction:: snakecord.utils.resolve_invite

.. autofunction:: snakecord.utils.resolve_template

.. autofunction:: snakecord.utils.sleep_until

.. autofunction:: snakecord.utils.utcnow

.. autofunction:: snakecord.utils.format_dt

.. autofunction:: snakecord.utils.as_chunks

.. data:: MISSING
    :module: snakecord.utils

    A type safe sentinel used in the library to represent something as missing. Used to distinguish from ``None`` values.

    .. versionadded:: 2.0

.. _snakecord-api-enums:
...
.. class:: UserFlags
    ...
    Represents Snakecord User flags.

    .. attribute:: staff

        The user is a Snakecord Employee.
    .. attribute:: partner

        The user is a Snakecord Partner.
    .. attribute:: hypesquad
    ...
    .. attribute:: premium_promo_dismissed
        ...
        The user has dismissed the Snakecord Nitro promotion.
    ...
    .. attribute:: system
        ...
        The user is a system user (i.e. represents Snakecord officially).
    ...
    .. attribute:: snakecord_certified_moderator
    ...
    .. attribute:: spammer
        ...
        The user is flagged as a spammer by Snakecord.
...
.. class:: VerificationLevel
    ...
    .. attribute:: low
        ...
        Member must have a verified email on their Snakecord account.
    .. attribute:: medium

        Member must have a verified email and be registered on Snakecord for more
        than five minutes.
    .. attribute:: high

        Member must have a verified email, be registered on Snakecord for more
        than five minutes, and be a member of the guild itself for more than
        ten minutes.
    .. attribute:: highest

        Member must have a verified phone on their Snakecord account.
...
.. class:: ContentFilter
    ...
    learning algorithms that Snakecord uses to detect if an image contains
...
.. class:: AuditLogAction
    ...
    .. attribute:: app_command_permission_update
        ...
        :class:`~snakecord.app_commands.AppCommand` for a specific commands permissions,
...
.. class:: WebhookType
    ...
    .. attribute:: channel_follower
        ...
        Represents a webhook that is internally managed by Snakecord, used for following channels.
...
.. class:: DefaultAvatar
    ...
    Represents the default avatar of a Snakecord :class:`User`
...
.. class:: Locale
    ...
    Supported locales by Snakecord. Mainly used for application command localisation.
...
.. class:: AuditLogDiff
    ...
    .. attribute:: app_command_permissions
        ...
        :type: List[:class:`~snakecord.app_commands.AppCommandPermissions`]
...
snakecord offers support for creating, editing, and executing webhooks through the :class:`Webhook` class.
...
.. attributetable:: snakecord.abc.Snowflake

.. autoclass:: snakecord.abc.Snowflake()
    :members:

User
~~~~~

.. attributetable:: snakecord.abc.User

.. autoclass:: snakecord.abc.User()
    :members:

PrivateChannel
~~~~~~~~~~~~~~~

.. attributetable:: snakecord.abc.PrivateChannel

.. autoclass:: snakecord.abc.PrivateChannel()
    :members:

GuildChannel
~~~~~~~~~~~~~

.. attributetable:: snakecord.abc.GuildChannel

.. autoclass:: snakecord.abc.GuildChannel()
    :members:

Messageable
~~~~~~~~~~~~

.. attributetable:: snakecord.abc.Messageable

.. autoclass:: snakecord.abc.Messageable()
    :members:
    :exclude-members: typing

    .. automethod:: snakecord.abc.Messageable.typing
        :async-with:

Connectable
~~~~~~~~~~~~

.. attributetable:: snakecord.abc.Connectable

.. autoclass:: snakecord.abc.Connectable()
    :members:

.. _snakecord_api_models:

Snakecord Models
---------------

Models are classes that are received from Snakecord and are not meant to be created by
...
Unlike :ref:`models <snakecord_api_models>` you are allowed to create
...
.. autoexception:: SnakecordException
...
.. autoexception:: SnakecordServerError
...
.. autoexception:: snakecord.opus.OpusError

.. autoexception:: snakecord.opus.OpusNotLoaded
