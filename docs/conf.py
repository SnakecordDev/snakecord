#
# snakecord documentation build configuration file, created by
...
extlinks = {
    'issue': ('https://github.com/SnakecordDev/snakecord/issues/%s', 'GH-%s'),
...
project = 'snakecord'
copyright = '2024-present, SnakecordDev'
...
html_context = {
  'snakecord_extensions': [
    ('snakecord.ext.commands', 'ext/commands'),
    ('snakecord.ext.tasks', 'ext/tasks'),
  ],
}

resource_links = {
  'issues': 'https://github.com/SnakecordDev/snakecord/issues',
  'discussions': 'https://github.com/SnakecordDev/snakecord/discussions',
  'examples': f'https://github.com/SnakecordDev/snakecord/tree/{branch}/examples',
}
...
htmlhelp_basename = 'snakecorddoc'
...
latex_documents = [
  ('index', 'snakecord.tex', 'snakecord Documentation',
   'SnakecordDev', 'manual'),
]
...
man_pages = [
    ('index', 'snakecord', 'snakecord Documentation',
     ['SnakecordDev'], 1)
]
...
texinfo_documents = [
  ('index', 'snakecord', 'snakecord Documentation',
   'SnakecordDev', 'snakecord', 'One line description of project.',
   'Miscellaneous'),
]
