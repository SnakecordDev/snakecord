.. _snakecord_ext_tasks:

``snakecord.ext.tasks`` -- asyncio.Task helpers
====================================================
...
The goal of this snakecord extension is to abstract all these worries away from you.

Recipes
---------

A simple background task in a :class:`~snakecord.ext.commands.Cog`:

.. code-block:: python3

    from snakecord.ext import tasks, commands
...
.. code-block:: python3
    ...
    from snakecord.ext import tasks
    import snakecord
...
.. code-block:: python3
    ...
    import datetime
    from snakecord.ext import commands, tasks
...
.. attributetable:: snakecord.ext.tasks.Loop

.. autoclass:: snakecord.ext.tasks.Loop()
    :members:
...
.. autofunction:: snakecord.ext.tasks.loop
    :decorator: