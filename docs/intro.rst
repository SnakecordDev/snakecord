...
This is the documentation for snakecord, a library for Python to aid
in creating applications that utilise the Snakecord API.

Prerequisites
---------------

snakecord works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``snakecord[voice]`` instead of ``snakecord``, e.g. ::
...
snakecord revolves around the concept of :ref:`events <snakecord-api-events>`.
