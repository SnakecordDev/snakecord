...
import asyncpg  # asyncpg is not a dependency of the snakecord, and is only included here for illustrative purposes.
import snakecord
...
class CustomBot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        if self.testing_guild_id:
            guild = snakecord.Object(self.testing_guild_id)
...
async def main():
    ...
    # see https://snakecordpy.readthedocs.io/en/latest/logging.html and https://docs.python.org/3/howto/logging.html
    ...
    # snakecord.utils.setup_logging(handler=handler, root=False)
