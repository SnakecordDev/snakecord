...
class DynamicCounter(
    snakecord.ui.DynamicItem[snakecord.ui.Button],
    ...
    @property
    def style(self) -> snakecord.ButtonStyle:
        if self.count < 10:
            return snakecord.ButtonStyle.grey
        if self.count < 15:
            return snakecord.ButtonStyle.red
        if self.count < 20:
            return snakecord.ButtonStyle.blurple
        return snakecord.ButtonStyle.green
