...
class Google(snakecord.ui.View):
    def __init__(self, query: str):
        super().__init__()
        # we need to quote the query string to make a valid url. snakecord will raise an error if it isn't valid.
        ...
        self.add_item(snakecord.ui.Button(label='Click Here', url=url))
