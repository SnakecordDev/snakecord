...
@pytest.mark.parametrize(
    ('url', 'code'),
    [
        ('https://snakecordapp.com/invite/dpy', 'dpy'),
        ('https://snakecord.com/invite/dpy', 'dpy'),
        ('https://snakecord.gg/dpy', 'dpy'),
    ],
)
...
@pytest.mark.parametrize(
    ('url', 'event_id'),
    [
        ('https://snakecordapp.com/invite/dpy', None),
        ('https://snakecord.com/invite/dpy', None),
        ('https://snakecord.gg/dpy', None),
        ('https://snakecordapp.com/invite/dpy?event=22222222', 22222222),
        ('https://snakecord.com/invite/dpy?event=4098', 4098),
        ('https://snakecord.gg/dpy?event=727', 727),
    ],
)
...
@pytest.mark.parametrize(
    ('url', 'code'),
    [
        ('https://snakecordapp.com/template/foobar', 'foobar'),
        ('https://snakecord.com/template/foobar', 'foobar'),
        ('https://snakecord.new/foobar', 'foobar'),
    ],
)
